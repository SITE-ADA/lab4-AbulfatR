...
@RestController // Proper stereotype for a controller that returns data (JSON), not HTML views
@RequestMapping("/api/products") // Sets the base URL for all endpoints in this class
public class ProductController {
    ...
    public ResponseEntity<Product> getProductById(@PathVariable UUID id) {
        try {
            ...
            // Gracefully handling the exception thrown by the service
